(function() {
  var Log, OmegaTargetCurrent, Promise, actionForUrl, charCodeUnderscore, dispName, drawContext, drawError, drawIcon, encodeError, external, iconCache, isHidden, options, refreshActivePageIfEnabled, state, storage, sync, syncStorage, tabs, timeout, unhandledPromises, unhandledPromisesId, unhandledPromisesNextId,
    __slice = [].slice,
  ...
  refreshActivePageIfEnabled = function() {
    ...
    return chrome.tabs.query({
      ...
      if (tabs[0].url && tabs[0].url.substr(0, 6) !== 'chrome') {
