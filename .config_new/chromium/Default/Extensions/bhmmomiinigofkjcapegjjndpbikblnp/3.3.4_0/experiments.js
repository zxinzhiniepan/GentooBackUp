...
//		},
		...
		ab: {
			options: ["cntrl_t1","lt_dnt_t1", "no_dnt_t1","lt_ws_t1","all_t1"],
			default: "cntrl_t1",
	...
	// returns the currently running exp variant if such exists
	get_current_exp_var: function(exp) {
		if (!this.list) { return null; }

		var eo = this.list[exp];
		if (eo && eo.current) {
			return eo.current;
		}
		return null;
