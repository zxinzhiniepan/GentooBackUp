...
(function() {
  angular.module('omega').controller('FixedProfileCtrl', function($scope, $modal, trFilter) {
    var defaultLabel, defaultPort, onBypassListChange, onProxyChange, proxyProperties, scheme, _fn, _i, _j, _len, _len1, _ref, _ref1;
    ...
    $scope.isProxyAuthActive = function(scheme) {
      var _ref1;
      return ((_ref1 = $scope.profile.auth) != null ? _ref1[proxyProperties[scheme]] : void 0) != null;
    };
    $scope.editProxyAuth = function(scheme) {
      var auth, prop, proxy, scope, _ref1;
      prop = proxyProperties[scheme];
      proxy = $scope.profile[prop];
      scope = $scope.$new('isolate');
      scope.proxy = proxy;
      auth = (_ref1 = $scope.profile.auth) != null ? _ref1[prop] : void 0;
    ...
    onProxyChange = function(proxyEditors, oldProxyEditors) {
      var proxy, _base, _j, _len1, _name, _ref1, _ref2, _results;
      if (!proxyEditors) {
        return;
      }
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        ...
        if (!proxy.scheme) {
          ...
          if (proxy.host == null) {
            proxy.host = (_ref2 = proxyEditors[''].host) != null ? _ref2 : 'example.com';
          }
        }
